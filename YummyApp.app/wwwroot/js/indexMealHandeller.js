            ...
            success: function (data) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $('#meals').DataTable().ajax.reload(null, false);
...
$(document).on('click', '.btn-update', function () {
    ...
    var Id = $(this).data('id');
    var UrlUpdate = '/Chef/Meal/Update/' + Id;
    ...
    $.get(UrlUpdate, function (data) {
        ...
        $("#kt_modal_update").on('submit', 'form', function (e) {
            ...
            $.ajax({
                url: "/Chef/Meal/Update", // Replace with your actual server URL to add/update the item
                type: 'POST',
                cache: false,
                data: formData,
                processData: false, // Important: prevent jQuery from processing the data
